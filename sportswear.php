            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/sw1.png" alt="img" />
                            <h3><strong class="black">Rs 1200</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/sw2.png" alt="img" />
                            <h3><strong class="black">Rs 1050</strong></h3>
                
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/sw3.png" alt="img" />
                            <h3><strong class="black">Rs 1100</strong></h3>
                            
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                        <div class="brand_box">
                            <img src="images/sw4.png" alt="img" />
                            <h3><strong class="black">Rs 950</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mrgn">
                        <div class="brand_box">
                            <img src="images/sw5.png" alt="img" />
                            <h3><strong class="black">Rs 1600</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mrgn">
                        <div class="brand_box">
                            <img src="images/sw6.png" alt="img" />
                            <h3><strong class="black">Rs 1000</strong></h3>
                        </div>
                    </div>
                    <div class="col-md-12">
