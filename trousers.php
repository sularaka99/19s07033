                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            ...
                            <h3>primeum linen frock</h3>
                            <h3><strong class="black">Rs 2100</strong></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            ...
                            <h3>primeum linen frock</h3>
                            <h3><strong class="black">Rs 2,400.00</strong></h3>
                
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/pro-img/ga003.jpg" alt="img" />
                            <h3>cool linen frock</h3>
                            <h3><strong class="black">Rs 2,100</strong></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                        <div class="brand_box">
                            ...
                            <h3>pcool linen frock</h3>
                            <h3><strong class="black">Rs 3,500</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mrgn">
                        <div class="brand_box">
                            <img src="images/pro-img/ga005.jpg" alt="img" />
                            <h3>pcool linen frock</h3>
                            <h3><strong class="black">Rs 3,800</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mrgn">
                        <div class="brand_box">
                            <img src="images/pro-img/ga006.jpg" alt="img" />
                            <h3>pcool linen frock</h3>
                            <h3><strong class="black">Rs 3,500</strong></h3>
                        </div>
                    </div>
