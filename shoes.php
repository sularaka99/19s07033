            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/sh1.png" alt="img" />
                            <h3><strong class="black">Rs 3200</strong></h3>
                            <a class="#">Add to Cart</a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/sh2.png" alt="img" />
                            <h3><strong class="black">Rs 3500</strong></h3>
                
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <div class="brand_box">
                            <img src="images/sh3.png" alt="img" />
                            <h3><strong class="black">Rs 3000</strong></h3>
                            
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                        <div class="brand_box">
                            <img src="images/sh4.png" alt="img" />
                            <h3><strong class="black">Rs 3500</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mrgn">
                        <div class="brand_box">
                            <img src="images/sh5.png" alt="img" />
                            <h3><strong class="black">Rs 4000</strong></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mrgn">
                        <div class="brand_box">
                            <img src="images/sh6.png" alt="img" />
                            <h3><strong class="black">Rs 3500</strong></h3>
                        </div>
                    </div>
                    <div class="col-md-12">
