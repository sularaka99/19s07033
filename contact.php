...
<body class="main-layout">
                    ...
                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="index.html"><img src="images/bg-img/sulzzlogo.jpg" alt="#"></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        <div id="contact" class="footer">
                    ...
                    <div class="col-md-12 ">
                        <div class="footer-box">
                            ...
                            <ul class="location_icon">
                                ...
                                <li> <a href="https://instagram.com/_sulazz_clothing?igshid=1ohuh9e9u05r6"><i class="fa fa-instagram"></i></a></li>
            ...
            <div class="copyright">
                <div class="container">
                    <p>© 2020 All Rights Reserved. Design By sualaraka madurapriya</p>
                </div>
            </div>
        </div>
    </footer>
